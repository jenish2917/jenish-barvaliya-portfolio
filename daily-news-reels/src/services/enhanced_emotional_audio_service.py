...
class EnhancedEmotionalAudioService:
    ...
    def __init__(self):
        ...
        self.max_duration = float(os.getenv('MAX_AUDIO_DURATION', '120'))
    ...
    def _init_providers(self):
        ...
        if AZURE_AVAILABLE:
            ...
            self.logger.info("Azure TTS available")
    ...
    def select_voice_personality(self, emotion: VoiceEmotion, category: str) -> str:
        ...
        # Enhanced category-specific overrides for news content
        ...
        elif category == 'business' and emotion == VoiceEmotion.SURPRISED:
            return 'excited_reporter'  # Breaking business news
        elif category == 'science' and emotion == VoiceEmotion.SURPRISED:
            return 'enthusiastic_host'  # Discovery announcements
        elif category in ['politics', 'world'] and emotion == VoiceEmotion.DRAMATIC:
            return 'dramatic_announcer'  # Serious news
        elif category == 'entertainment' and emotion == VoiceEmotion.PLAYFUL:
            return 'casual_friend'  # Celebrity/fun news
    ...
    def generate_emotional_voiceover(self, script: str, title: str, category: str = 'general', 
        ...
        try:
            ...
            self.logger.error(f"Error generating emotional voiceover: {e}")
            return None, None
