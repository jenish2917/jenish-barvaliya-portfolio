...
const Skills = ({ darkMode }) => {
  ...
  return (
    <section id="skills" className="py-16 sm:py-20 relative pt-20 sm:pt-28">
            ...
            {Object.entries(skills).map(([category, categorySkills], categoryIndex) => (
              ...
              >
                ...
                <div className="text-center">
                  <h3 className={`text-xl sm:text-2xl md:text-3xl font-bold ${darkMode ? 'text-white' : 'text-black'} mb-3 sm:mb-4`}>
                    {category}
                  </h3>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        <div className="flex items-center space-x-2 sm:space-x-3">
                          ...
                          <h4 className={`text-sm sm:text-base font-semibold ${darkMode ? 'text-white' : 'text-black'} group-hover:${darkMode ? 'text-gray-300' : 'text-gray-700'} transition-colors`}>
                            {skill.name}
                          </h4>
                        </div>
                        <span className={`text-xs sm:text-sm font-mono ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                          {skill.level}%
                        </span>
                      </div>
