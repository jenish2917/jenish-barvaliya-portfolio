...
const About = ({ darkMode }) => {
  ...
  const highlightIcons = [
    { icon: Brain, color: "text-purple-400", bg: "bg-purple-500/10", label: "AI/ML" },
    { icon: Code, color: "text-blue-400", bg: "bg-blue-500/10", label: "Development" },
    { icon: Database, color: "text-green-400", bg: "bg-green-500/10", label: "Data Science" },
    { icon: Lightbulb, color: "text-yellow-400", bg: "bg-yellow-500/10", label: "Innovation" }
  ]
            ...
            <motion.div variants={itemVariants} className="space-y-10">
              <div className="relative">
                ...
                <motion.div
                  ...
                  className={`relative w-96 h-96 mx-auto rounded-3xl ${
                    darkMode ? 'bg-gradient-to-br from-gray-800 via-gray-900 to-black' : 'bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300'
                  } flex items-center justify-center shadow-2xl border border-white/10 backdrop-blur-sm`}
                >
                  <div className={`text-9xl ${darkMode ? 'text-gray-600' : 'text-gray-400'}`}>
                    👨‍💻
                  </div>
                  
                  {/* Glowing border effect */}
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-purple-500/20 via-blue-500/20 to-green-500/20 blur-xl -z-10" />
                </motion.div>
